...
import com.example.amhso.nlpapp_doctor.otherclass.message;
import com.example.amhso.nlpapp_doctor.service.MessageService;
...
public class ChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        id_doctor=sharedpreferences.getString(G.id_user ,"-1");
        ...
        Log.i("dddddddddddddddrrrrrrr", "onCreate: "+id_doctor+"----"+id_sick);
        ...
        send.setOnClickListener(new View.OnClickListener() {
            public void onClick(View arg0) {
                ...
                task.execute(G.urlserver + "insert_message_private_doctor");
        ...
        HttpPostAsyncTask task = new HttpPostAsyncTask();
        task.execute(G.urlserver + "fetch_message_private_doctor");
    ...
    public class HttpPostAsyncTask extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                contacts = jsonObj.getJSONArray("message_private");
                ...
                for (int i = 0; i < contacts.length(); i++) {
                    ...
                    String doctor_sick = c.getString("doctor_sick");
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                nameValuePairs.add(new BasicNameValuePair("id_doctor", id_doctor.trim()));
    ...
    private class uploadImage extends AsyncTask<Void,Void,String>{
        ...
        protected String doInBackground(Void...params){
            ...
            try{
                ...
                HttpPost httpPostRequest = new HttpPost(G.urlserver+"chat_upload_private_doctor?id_doctor="+id_doctor.trim()+"&&id_sick="+id_sick);
...
//                Bitmap bitmap= BitmapFactory.decodeFile(Environment.getExternalStorageDirectory()+"/Rose.jpg");
                ...
                InputStreamBody inputStreamBody = new InputStreamBody(new ByteArrayInputStream(data), "/index_files/darmalena.jpg");
